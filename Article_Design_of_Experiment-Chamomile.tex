...
\nomenclature[A]{\(\mathcal{R}\)}{Control cost matrix}
...
% Greek symbols
\nomenclature[B]{\(\alpha\)}{Temperature-dependent function in the P-R EoS}
\nomenclature[B]{\(\Delta_\theta\)}{Residual term of the parameters}
\nomenclature[B]{\(\Delta_y\)}{Residual term of the measurement error \nomunit{g}}
\nomenclature[B]{\(\epsilon\)}{Unobservable error}
\nomenclature[B]{\(\gamma\)}{Decaying function}
\nomenclature[B]{\(\kappa\)}{Quadratic function of the acentric factor}
\nomenclature[B]{\(\mu\)}{Sphericity coefficient}
\nomenclature[B]{\(\phi\)}{Bed porosity}
\nomenclature[B]{\(\pi\)}{Probability density}
...
\nomenclature[B]{\(\Sigma_\theta\)}{Parameter uncertainty matrix}
\nomenclature[B]{\(\Sigma_Y\)}{Measurement covariance matrix}
\nomenclature[B]{\(\Theta\)}{Parameter space}
\nomenclature[B]{\(\theta\)}{Vector of analysed parameters}
\nomenclature[B]{\(\Upsilon\)}{Decay coefficient}
\nomenclature[B]{\(\varkappa\)}{An arbitrary function of \(\mathcal{A}\)}
\nomenclature[B]{\(\Xi\)}{Matrix of experimental conditions}
\nomenclature[B]{\(\xi\)}{Vector of experimental conditions}
...
\nomenclature[C]{P-R EoS}{Peng-Robinson Equation of State}
