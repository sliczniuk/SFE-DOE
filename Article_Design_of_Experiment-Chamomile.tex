...
Table \ref{fig: SFE_Literature} provides a list of studies on SFE including the modeling part presented from 2014 onwards
...
\begin{table*}[h!]
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{1.75cm}|p{4.5cm}|p{1.5cm}|p{1.5cm}|p{3cm}|}
		...
		\citet{Tomita2014} & Rice bran & CO$_2$ & Partitioning coefficient model (\citet{Kubatova2002}) & 40–80 & 20-40 & 0.17-1.5$\times 10^{-4}$ [L/s]\\ 
		\hline
	\end{tabular} }
