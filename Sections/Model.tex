...
\begin{document}
	...
	Assuming that {\color{blue}the porosity} and mass flow rate is constant in time, the temporal derivative becomes the mass flux F, and the spatial derivative can be integrated along $z$ as
	...
	{\footnotesize
		\begin{equation} 
			...
			The volumetric partition coefficient $k_p$ acts as an equilibrium constant between the solute concentration in one phase and the corresponding equilibrium concentration at the solid-fluid interphase. \citet{Spiro2007} proposed to define the mass partition coefficient $k_m$ and the solid density $\rho_s$ as 
