...
%% Create the solver
Iteration_max               = 500;                                          % Maximum number of iterations for optimzer
...
for i = 1:3
    ...
    yyaxis right
    stairs([0 OP_change], [KOUT_MATRIX(II,1:30) KOUT_MATRIX(II,30)], 'LineWidth', 2)
    ylabel('Pressure bar')

    yyaxis left
    stairs([0 OP_change], [KOUT_MATRIX(II,31:end) KOUT_MATRIX(II,end)], 'LineWidth', 2)
